              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form method="post" action="model/do_update_tpa.php">
                          ...
                          <?php endif ?>
                          <?php foreach ($db->select('hasil_tpa.*,alternatif.id_alternatif,alternatif.nama','hasil_tpa,alternatif')->where('hasil_tpa.id_alternatif=alternatif.id_alternatif and hasil_tpa.id_alternatif='.$_GET['id'])->get() as $data): ?>
